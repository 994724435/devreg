...
//	}
   //主页
    ...
    public function base(){
        ...
        $data = M("Index")->where(array('id'=>$id))->find();
        $this->assign("data",$data);
        $this->display('./Public/Home/One/base.html');
    }
    ...
    public function tougao(){
        ...
        $data = M("Index")->where(array('id'=>$id))->find();
        $this->assign("data",$data);
        $this->display('./Public/Home/One/tougao.html');
    }
    ...
    public function content(){
        ...
        $data = M("Index")->where(array('id'=>$id))->find();
        $this->assign("data",$data);
        $this->display('./Public/Home/One/content.html');
    }
    ...
    public function hotel(){
        ...
        $data = M("Index")->where(array('id'=>$id))->find();
        $this->assign("data",$data);
        $this->display('./Public/Home/One/hotel.html');
    }
    ...
    public function contact(){
        ...
        $data = M("Index")->where(array('id'=>$id))->find();
        $this->assign("data",$data);
        $this->display('./Public/Home/One/contact.html');
    }
