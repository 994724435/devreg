...
CKEDITOR.plugins.add('wordcount', {
    ...
    init: function (editor) {
        ...
        function CntId(editorInstance) {
            return 'Cnt_' + editorInstance.name;
        }
        function counterElement(editorInstance) {
            return document.getElementById(counterId(editorInstance));
        }
        function CntElement(editorInstance) {
            return document.getElementById(CntId(editorInstance));
        }
        ...
        function updateCounter(editorInstance) {
            ...
            CntElement(editorInstance).value = charCount;
            if (editorInstance.name == "Resume")
            {
                totalWordCount = parseInt($("#Cnt_Resume").val());
            }
            else
            {
                totalWordCount = parseInt($("#Cnt_AbstractModel_Abstract").val()) + parseInt($("#Cnt_AbstractModel_objective").val()) + parseInt($("#Cnt_AbstractModel_method").val()) + parseInt($("#Cnt_AbstractModel_result").val()) + parseInt($("#Cnt_AbstractModel_conclusion").val());
            }
            $("#Abs_word_cnt").val(totalWordCount);

            if ($('#Abs_word_cnt').val() > parseInt($("#abstract_word_num").val())) {
                //alert('字数请限制在 ' + $("#abstract_word_num").val() + ' 字以内');
